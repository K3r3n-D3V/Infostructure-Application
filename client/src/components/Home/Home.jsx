 ...
 const productscreen = () => {
  ...
  return (
    <div>
      ...
      <div className="box">
        <div className="box2">
          <h1>Home sweet <span className='span'>stylish</span> home.</h1>
          <p className='designers'>A warm, welcoming sanctuary filled with personal touches and peaceful comfort</p>
    ...
    <div className="box3 designers">
        ...
        <div className="collection-item">
          <div className="collection-pic">
            <img src="../../Screens/pic1.jpg" alt="" onClick={productscreen}/>
        ...
        <div className="collection-item">
          <div className="collection-pic">
            <img src="../../Screens/pic2.jpg" alt="" onClick={productscreen}/>
            <div className="collection-info designer">
        ...
        <div className="collection-item">
          <div className="collection-pic">
            <img src="../../Screens/pic3.jpg" alt="" onClick={productscreen}/>
            <div className="collection-info designer">
              <h1>Agnes Levine</h1>
        ...
        <div className="collection-item">
          <div className="collection-pic">
            <img src="../../Screens/pic4.jpg" alt="" onClick={productscreen}/>
            <div className="collection-info designer">
              <h1>Patrick Dior</h1>
      ...
      <div className="collection">
        <div className="collection-item">
          <div className="collection-pic">
            <img src="../../Screens/pic5.jpg" alt="" onClick={productscreen}/>
            <div className="collection-info designer">
        ...
        <div className="collection-item">
          <div className="collection-pic">
            <img src="../../Screens/pic6.jpg" alt="" onClick={productscreen}/>
            <div className="collection-info designer">
        ...
        <div className="collection-item">
          <div className="collection-pic">
            <img src="../../Screens/pic8.jpg" alt="" onClick={productscreen}/>
            <div className="collection-info designer">
              <h1>Emma Bulore</h1>
              {/* <p>kjgvkyh</p> */}
            </div>
    ...
    <div className="box3">
        ...
        <div className="collection-item">
          <div className="collection-pic">
            <img src="../../Screens/cat-living-room.webp" alt="" onClick={productscreen}/>
        ...
        <div className="collection-item">
          <div className="collection-pic">
            <img src="../../Screens/cat-dining-room.webp" alt="" onClick={productscreen}/>
            <div className="collection-info">
              <h1>Dining Room</h1>
        ...
        <div className="collection-item">
          <div className="collection-pic">
            <img src="../../Screens/cat-decor.webp" alt="" onClick={productscreen}/>
            <div className="collection-info">
              <h1>Decor & more</h1>
              <p>Eye-catching accents to complete your look</p>
            </div>
        ...
        <div className="collection-item">
          <div className="collection-pic">
            <img src="../../Screens/cat-bedroom.webp" alt="" onClick={productscreen}/>
            <div className="collection-info">
              <h1>Bedroom</h1>
              <p>Dreamy furniture fit for royalty</p>
            </div>
      ...
      <div className="collection">
        <div className="collection-item">
          <div className="collection-pic">
            <img src="../../Screens/babykids.jpg" alt="" onClick={productscreen}/>
            <div className="collection-info">
              <h1>Baby & Kids</h1>
        ...
        <div className="collection-item">
          <div className="collection-pic">
            <img src="../../Screens/bathroom.jpg" alt="" onClick={productscreen}/>
            <div className="collection-info">
              <h1>Bathroom</h1>
              <p>Bathtubs, sinks and more to create a unique oasis of refreshment</p>
            </div>
        ...
        <div className="collection-item">
          <div className="collection-pic">
            <img src="../../Screens/kitchen.jpg" alt="" onClick={productscreen}/>
            <div className="collection-info">
              <h1>Kitchen</h1>
              <p>Warm, inviting, culinary hub of creativity</p>
            </div>
        ...
        <div className="collection-item">
          <div className="collection-pic">
            <img src="../../Screens/outdoor.jpg" alt="" onClick={productscreen}/>
            <div className="collection-info">
              <h1>Outdoor</h1>
    ...
    <div className="email-container">
      ...
      <input type="email" className='email-input search-input' placeholder='Email Address' />
