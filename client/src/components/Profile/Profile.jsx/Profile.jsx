...
const UserProfile = () => {
  ...
  return (
    ...
    <Box className="profile-container" sx={{ p: 2, maxWidth: 550, mx: 'auto', textAlign: 'center' }}>
     ...
     <img src="../../Screens/profile.jpg" alt="" />
      ...
      <button onClick={handleLogout} style={{ backgroundColor: 'blue', color: 'white', width: '100%' }}>
        Log Out
      </button>
    </Box>
    </div>
